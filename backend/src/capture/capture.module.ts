...
class CaptureController {
  ...
  // Captura NÃO tem mais aprovação: quem tem capture:request dispara e já
  // começa (ver CaptureService.requestCapture). Os endpoints de approve/reject
  // foram removidos junto da permissão capture:approve.
  @RequirePermission('capture:request')
  ...
  // Parar manualmente uma captura em andamento.
  @RequirePermission('capture:request')
  @Audit('capture.stop')
  @Post(':id/stop')
